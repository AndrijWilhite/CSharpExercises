...
namespace CSharpExercises
{
    public static class Exercises
    {
        ...
        public static string GetFirstName(string nameInput)
        {
        ...
        public static string ReverseStringHard(string rut)
        {
            string Rev = "";
        ...
        public static string ReverseStringEasy(string lut)
        {
            char[] inputarray = lut.ToCharArray();
            Array.Reverse(inputarray);
            string lol = new string(inputarray);
            return lol;
        }
        ...
        {
           double Fah = 1.8*(kelvin-273.15)+32;
            return Math.Round(Fah,2);
        }
        ...
        public static string DrawTriangle(int number, int width)
        {
            ...
            {
              result += String.Concat(Enumerable.Repeat(number.ToString(), i));
                if (i != 1) result += Environment.NewLine;
            }
        ...
        public static string GetMilesPerHour(double distance, int hours, int minutes, int seconds)
        {
            ...
            double disSec = distance / sec;
            double mph = disSec * 3600;
            string speed = Math.Round(mph) + "MPH";
            return speed;
        }
        ...
        public static double MortgageCalculator(double balance, double interest, int loanYears, int paymentPeriod)
        {
                interest = interest/100;
                double monthlyInterest = interest/paymentPeriod;
                double payments = paymentPeriod*loanYears;
                double x = monthlyInterest * Math.Pow((1 + monthlyInterest), payments);
                double y = Math.Pow((monthlyInterest+1), payments) - 1;
                return Math.Round(balance * (x / y), 2);
        }
